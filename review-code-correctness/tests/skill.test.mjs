...
const NAME = "review-code-correctness";
const KIND = "specialist";
const AREA = "correctness";
const DESCRIPTION = "Specialist review lens for functional correctness: logic errors, edge cases, invariants, null handling, and error paths. Use as a focused lens, usually routed by the review-code orchestrator, when changed logic, conditionals, parsing, validation, or error handling needs a behavior-bug check.";
const OPENAI_DISPLAY = "Review Code: Correctness";
// ----------------------------------------------------------------------------
