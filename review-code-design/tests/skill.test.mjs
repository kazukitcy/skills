...
const NAME = "review-code-design";
const KIND = "specialist";
const AREA = "design and maintainability";
const DESCRIPTION = "Specialist review lens for design and maintainability: module boundaries, API contracts, dependency direction, and future change safety. Use as a focused lens, usually routed by the review-code orchestrator, when changes affect public contracts, layering, coupling, or where responsibility for logic lives.";
const OPENAI_DISPLAY = "Review Code: Design & Maintainability";
// ----------------------------------------------------------------------------
