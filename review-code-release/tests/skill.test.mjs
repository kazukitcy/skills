...
const NAME = "review-code-release";
const KIND = "specialist";
const AREA = "release and operability";
const DESCRIPTION = "Specialist review lens for release risks: migrations, config, feature flags, deploy ordering, rollback, and observability. Use as a focused lens, usually routed by the review-code orchestrator, when changes touch schema migrations, backfills, config, feature flags, deploy ordering, rollback, or observability.";
const OPENAI_DISPLAY = "Review Code: Release & Operability";
// ----------------------------------------------------------------------------
