...
const NAME = "review-code-reliability";
const KIND = "specialist";
const AREA = "reliability";
const DESCRIPTION = "Specialist review lens for reliability risks: concurrency, retries, idempotency, timeouts, partial failure, transactions, and locks. Use as a focused lens, usually routed by the review-code orchestrator, when changes touch async jobs, retries, locks, transactions, queues, or anything with partial-failure or ordering risk.";
const OPENAI_DISPLAY = "Review Code: Reliability";
// ----------------------------------------------------------------------------
