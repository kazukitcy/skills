...
const NAME = "review-code-security";
const KIND = "specialist";
const AREA = "security and privacy";
const DESCRIPTION = "Specialist review lens for security and privacy risks: authentication, authorization, tenant isolation, PII, secrets, injection, and data exposure. Use as a focused lens, usually routed by the review-code orchestrator, when changes touch auth, permissions, tenant boundaries, PII, secrets, input handling, uploads, webhooks, or data export.";
const OPENAI_DISPLAY = "Review Code: Security & Privacy";
// ----------------------------------------------------------------------------
