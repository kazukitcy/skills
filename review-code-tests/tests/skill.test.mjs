...
const NAME = "review-code-tests";
const KIND = "specialist";
const AREA = "test adequacy";
const DESCRIPTION = "Specialist review lens for test adequacy: missing, weak, brittle, or misleading tests, and targeted verification for changed behavior. Use as a focused lens, usually routed by the review-code orchestrator, when changed behavior lacks tests or regression, boundary, authorization, or concurrency coverage may be inadequate.";
const OPENAI_DISPLAY = "Review Code: Test Adequacy";
// ----------------------------------------------------------------------------
