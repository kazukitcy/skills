# Microsoft Rust Guidelines: Documentation

Source: <https://github.com/microsoft/rust-guidelines> at commit `95ac4c828fb8`, `src/guidelines/docs/`. Copyright (c) Microsoft Corporation, MIT license (see `LICENSE-MS-GUIDELINES` at the skill root). Text lightly reformatted: anchors and cross-links converted, figures omitted.

<a id="m-first-doc-sentence"></a>
## First sentence is one line; approx. 15 words (M-FIRST-DOC-SENTENCE)
**Why:** easily skimmable API docs.
...
*(Figure omitted; see M-FIRST-DOC-SENTENCE_GOOD.png in the upstream repository.)*

Otherwise, you might end up with _widows_ and a generally unpleasant reading flow:

*(Figure omitted; see M-FIRST-DOC-SENTENCE_BAD.png in the upstream repository.)*
...
**Why:** established Rust documentation practices.
...
**Why:** re-exported items that fit in with their siblings.
...
*(Figure omitted; see M-DOC-INLINE_BAD.png in the upstream repository.)*
...
*(Figure omitted; see M-DOC-INLINE_GOOD.png in the upstream repository.)*
...
[M-NO-GLOB-REEXPORTS]: ms-libs-resilience.md#m-no-glob-reexports