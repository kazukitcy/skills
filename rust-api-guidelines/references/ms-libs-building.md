# Microsoft Rust Guidelines: Libraries: Building

Source: <https://github.com/microsoft/rust-guidelines> at commit `95ac4c828fb8`, `src/guidelines/libs/building/`. Copyright (c) Microsoft Corporation, MIT license (see `LICENSE-MS-GUIDELINES` at the skill root). Text lightly reformatted: anchors and cross-links converted, figures omitted.

<a id="m-oobe"></a>
## Libraries work out of the box (M-OOBE)
**Why:** easy adoption across the Rust ecosystem.
...
**Why:** libraries that just work on all platforms.
...
**Why:** reliable compilation in large, complex projects.
