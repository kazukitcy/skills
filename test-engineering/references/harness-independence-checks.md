# Harness independence checks

Independent harnesses reduce shared blind spots. Independence is not just a
different filename or test framework.
...
- different authoring style: hand-written tests vs property tests vs scenario
  traces
...
- high-level tests call the same helper as unit tests to compute expected
  values
...
- What independent evidence would catch this if the main test helper were
  wrong?
