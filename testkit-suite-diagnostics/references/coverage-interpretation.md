...
Coverage tools may show a comparison executed but not whether both sides around the boundary were meaningful. Add explicit cases for:

- just below boundary
- at boundary
- just above boundary
- invalid or overflow-adjacent values when applicable
